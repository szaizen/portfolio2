...
$('.work--card-5').on('click',function(){
 showModal('','<div class="work--list-modal">   <div class="work--list-left">    <img src="image/display.png" class="image--display display--pc"><img src="image/display-sp.png" class="image--display display--sp">    <div class="image--pc">      <img src="image/enclass.png" class="image--scroll">    </div>  </div>  <div class="work--list-right">    <p class="work--list-title"> コミュニティ「Enclass」／ ブログ、イベント </p>    <p class="work--list-detail"> プロジェクト人数：3名<br> 担当分野：フロントエンド開発<br> 使用ツール：Wordpress、Backlog、Slack<br>開発内容：一からWordpressのカスタムテーマを作成。 </p>  </div></div>');
});
/*
<div class="work--list-modal"> 
  <div class="work--list-left">
    <img src="image/display.png" class="image--display display--pc">
    <img src="image/display-sp.png" class="image--display display--sp">
    <div class="image--pc">
      <img src="image/enclass.png" class="image--scroll">
    </div>
  </div>
...
$('.work--card-3').on('click',function(){
 showModal('','<div class="work--list-modal">  <div class="work--list-left">    <img src="image/display.png" class="image--display display--pc"><img src="image/display-sp.png" class="image--display display--sp">    <div class="image--pc">      <img src="image/pasonatechsystems.png" class="image--scroll">    </div>  </div>  <div class="work--list-right">    <p class="work--list-title">      「パソナテックシステムズ」／コーポレートサイトリニューアル    </p>    <p class="work--list-detail">      URL：<a href=" https://systems.pasonatech.co.jp/" target="_blank">https://systems.pasonatech.co.jp/</a><br>      担当分野：メインデザイン、フロント開発<br>      使用ツール：Wordpress,asana,slack,AdobeXD<br>      開発内容：プロトタイプを作成し、デザインの考案。サイト内に使用する写真の選別。HTML,CSSやプラグインを使用してフロントのスタイル調整。<br>      開発期間：約3か月間<br>    </p>  </div></div>');
});
/*
<div class="work--list-modal">
  <div class="work--list-left">
...
<img src="image/display-sp.png" class="image--display display--sp">
    <div class="image--pc">
      <img src="image/pasonatechsystems.png" class="image--scroll">
    </div>
  </div>
	<div class="work--list-right">
...
$('.work--card-4').on('click',function(){
 showModal('','<div class="work--list-modal">  <div class="work--list-left">    <img src="image/display.png" class="image--display display--pc"><img src="image/display-sp.png" class="image--display display--sp">    <div class="image--pc">      <img src="image/music_pc.png" class="image--scroll">    </div>  </div>  <div class="work--list-right">    <p class="work--list-title">      「M:usic」／ 音楽販売風サイト（勉強用）    </p>    <p class="work--list-detail">      プロジェクト人数：1名<br>      使用ツール：Salesforce<br>      開発内容：Apex、Visualforceをフルスクラッチ開発し、ログイン機能・ユーザ登録機能・カート機能を実装。<br>       開発期間：約1か月間<br>      <a style="margin: 0 10px;" href="https://github.com/szaizen/music" target="_blank">Github</a><a style="margin: 0 10px;" href="https://qiita.com/szaizen/items/83f58c344c4478bb1520" target="_blank">Qiita</a>      </p>  </div></div>');
});
/* 
<div class="work--list-modal">
  <div class="work--list-left">
...
<img src="image/display-sp.png" class="image--display display--sp">
    <div class="image--pc">
      <img src="image/music_pc.png" class="image--scroll">
    </div>
  </div>
  <div class="work--list-right">
    <p class="work--list-title">
...
$('.work--card-2').on('click',function(){
 showModal('','<div class="work--list-modal">  <div class="work--list-left">    <img src="image/display.png" class="image--display display--pc"><img src="image/display-sp.png" class="image--display display--sp">    <div class="image--pc">      <img src="image/signpost.png" class="image--scroll">    </div>  </div>  <div class="work--list-right">    <p class="work--list-title">      「Signpost」／ 複業に関するメディア   </p>    <p class="work--list-detail">      URL：<a href="http://signpost.anotherworks.co.jp/" target="_blank">http://signpost.anotherworks.co.jp/</a><br>      開発人数：1名<br>      使用ツール：Wordpress<br>      開発内容：デザイン・コーディング・SEO対策・移行から運用、保守まで一人で担当<br>       開発期間：約1ヶ月半<br>    </p>  </div></div>');
});
/* 
<div class="work--list-modal">
  <div class="work--list-left">
...
<img src="image/display-sp.png" class="image--display display--sp">
    <div class="image--pc">
      <img src="image/signpost.png" class="image--scroll">
    </div>
  </div>
  <div class="work--list-right">
    <p class="work--list-title">
...
$('.work--card-1').on('click',function(){
 showModal('','<div class="work--list-modal">  <div class="work--list-left">    <img src="image/display.png" class="image--display display--pc"><img src="image/display-sp.png" class="image--display display--sp">    <div class="image--pc">      <img src="image/anotherworks.png" class="image--scroll">    </div>  </div>  <div class="work--list-right">    <p class="work--list-title">      「Another works」<br> LP    </p>    <p class="work--list-detail">      URL：<a href="https://aw-anotherworks.com/" target="_blank">https://aw-anotherworks.com/</a><br>      開発内容：ランディングページを作成<br>       開発期間：約3日<br>    </p>  </div></div>');
/*
<div class="work--list-modal">
  <div class="work--list-left">
    <img src="image/display.png" class="image--display display--pc">
<img src="image/display-sp.png" class="image--display display--sp">
    <div class="image--pc">
      <img src="image/anotherworks.png" class="image--scroll">
    </div>
  </div>
  <div class="work--list-right">
    <p class="work--list-title">
